...
app.layout = dbc.Container([
    ...
    dbc.Row([
        ...
        dbc.Col([
            html.H5("Controls"),
            html.Hr(),
            html.Label("SiPM 0 Gain:"),
            dcc.Slider(id='gain0-slider', min=0.01, max=1, step=0.01, value=0.5, marks=None, tooltip={"placement": "bottom", "always_visible": True}),
            html.Label("SiPM 1 Gain:"),
            dcc.Slider(id='gain1-slider', min=0.01, max=1, step=0.01, value=0.5, marks=None, tooltip={"placement": "bottom", "always_visible": True}),
...
def update_graphs(n, x_key_in, y_key_in, x_scale, y_scale,
    ...
    signal_fig.update_layout(title="SiPM Data", xaxis_title="Time (ms)", yaxis_title="Voltage", yaxis_range=[0, 1.1], legend_title="Signals", uirevision='signal_layout')
